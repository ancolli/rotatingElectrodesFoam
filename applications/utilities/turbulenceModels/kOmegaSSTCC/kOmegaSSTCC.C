...
tmp<volScalarField>
kOmegaSSTCC<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTCC<BasicTurbulenceModel>::F2() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTCC<BasicTurbulenceModel>::F3() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField>
kOmegaSSTCC<BasicTurbulenceModel>::F23() const
{
...
kOmegaSSTCC<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal>
kOmegaSSTCC<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix>
kOmegaSSTCC<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix>
kOmegaSSTCC<BasicTurbulenceModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaSSTCC<BasicTurbulenceModel>::Qsas
(
...
// R-C correction
    ...
    (
        IOobject
        (
            IOobject::groupName("Fr1", alphaRhoPhi.group()),
            this->runTime_.timeName(),
            this->mesh_,
            IOobject::MUST_READ,
            IOobject::AUTO_WRITE
...
///////////////////
    ...
    volScalarField Fr1(this->Fr1(rStar, rTilda)); // Fr1

    {
        ...
        (
         ...
         ==
            alpha()*rho()*gamma*Fr1()   //curvature correction
           *min
            (
                GbyNu,
    ...
    (
     ...
     ==
        alpha()*rho()*Pk(G)*Fr1()    //curvature correction
